...
Master contains implementation source and tests for parts of the service, agent adapters and terminal. That source has not been established as a verified installed, connected outcome by this roadmap. The first feature planning pass checks the environment contract and existing code, reuses proven components, and identifies the smallest connected result. No outcome above is marked delivered by documentation or file presence alone.
