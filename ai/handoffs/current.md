...
- Next: [Connect the CLI to recorded service activity](../../docs/outcomes/runtime-service.md#connect-the-cli-to-recorded-service-activity), the next outcome in roadmap order; assess it against existing code and installed behavior.
