...
- Status: [verified development environment milestone](../../docs/planning/milestones.md) evidence recorded 2026-09-23 in the [prerequisite pass](../../docs/planning/prerequisite-pass.md). Codex, Claude Code and local Qwen each ran through the real workspace, isolation and egress path, before and after the installed service was upgraded to `master` `ebbb1a1`. The milestone is not marked complete.
- Next: decide milestone acceptance, then assess the persistent service.
- Deferred: the automatic installer and rollback belong to the first service-changing milestone, the persistent service. Not yet observed: the Claude setup token's real lifetime.
