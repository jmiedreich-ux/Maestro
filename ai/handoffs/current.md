...
- Open: agent-written run files need an elevated reset; the installed service does not yet include the Qwen route; the Claude setup token's real lifetime is unverified.
