# Terminal workspace — starting context

Status: source-supported starting knowledge for manual architecture preparation, version 1. Specialist owner: Terminal workspace. The architect created this context; no implementation session is active.
...
The new maestro command connects to the installed service; it does not start it, write SQL or replay uncertain mutations. The current workspace design is in the architecture, not established by old command names.
