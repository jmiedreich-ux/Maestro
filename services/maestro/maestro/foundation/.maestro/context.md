...
Status: source-supported starting knowledge for manual architecture preparation, version 1. Specialist owner: Runtime foundations. The architect created this context; no implementation session is active.
