# Service and transport — starting context

Status: source-supported starting knowledge for manual architecture preparation, version 1. Specialist owner: Service and transport. The architect created this context; no implementation session is active.
