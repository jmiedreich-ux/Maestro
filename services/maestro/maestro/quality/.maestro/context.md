# Milestone quality — starting context

Status: source-supported starting knowledge for manual architecture preparation, version 1. Specialist owner: Milestone quality. The architect created this context; no implementation session is active.
...
A source/test name cannot prove the capability under test. Operator catalog is unavailable; production access and guessed test bindings are prohibited. Required unavailable paths remain UNTESTED.
