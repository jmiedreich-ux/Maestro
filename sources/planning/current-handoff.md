...
3. M2 (Atlas reporting, with named operator-action commands becoming
   ...
   and a fresh `-02` candidate must restate that disclosure using only
   exhaustively-verified claims. Each subsequent wave slice still
