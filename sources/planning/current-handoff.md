...
3. M2 (Atlas reporting, with named operator-action commands becoming
   ...
   (Performance header/stats) is merged — a standalone
   `PerformanceHeader` with zero disclosed color literals, pure
