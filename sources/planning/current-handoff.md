...
3. M2 (Atlas reporting, with named operator-action commands becoming
   ...
   non-authoritative, and a fresh `-02` candidate must check every
   location stating or implying that count, including code-comment
   docstrings, not only narrative prose. Each subsequent wave slice
