...
class CommandApiScaffoldTests(unittest.TestCase):
    ...
    def test_11_only_the_real_command_routes_this_repository_actually_wires_are_registered_in_production_code(self) -> None:
        ...
        # third — dispatch-correction — and M3 E6 a fourth —
        # redispatch-crash (see
        # tests/m3_wave_e/test_dispatch_correction_command.py and
        # tests/m3_wave_e/test_redispatch_crash_command.py). This
        ...
        self.assertEqual(
            read_api._COMMAND_ROUTES,
            {
                ...
                "/command/redispatch-crash": read_api._handle_redispatch_crash,
            },
        )
