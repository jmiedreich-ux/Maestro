...
| GitHub and test targets | Required read/write access to the actual repository and test destination; verify GitHub app permissions including Administration: read only where an operation requires it, and branch protections in the private QA repository for the intended write. |
