...
This manual registration covers the current [ordered development outcomes](outcomes.md) on master. Changes to authoritative sources are tracked by Git; each implementation and review uses the exact revision it actually inspects. It includes the development environment outcome and the complete product scope in the [project overview](../project-overview.md), [architecture](../architecture.md), and six [outcome specifications](../outcomes/).
