...
**Status:** Proposed — planning only; not executable until the exact packet branch receives fresh Decision Fidelity Review and the approved packet status is recorded on `master`.  
