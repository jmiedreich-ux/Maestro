> **Restored to master 2026-09-10** from the archived branch
> `archive/architecture/m1-m4-packets`, where it had sat unpushed. This is the
> **original, Owner-approved** decision of 2026-09-01. A separate file,
> `m0-d15-real-m1-m4-implementation-path.md`, is a 2026-09-06 *reconstruction*
> written in the belief that this original was unrecoverable; it recovered only
> the M1–M4 numbering. Where the two differ, this one is the Owner's decision.
> Note it retires two decisions still recorded elsewhere as live: "Synthetic
> Control-Loop Qualification Before Foundry V1" and "Foundry as the V1 Proving
> Project".
